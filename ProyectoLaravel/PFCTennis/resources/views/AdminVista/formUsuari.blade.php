...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 py-4 px-4 shadow-lg mt-3">
            @if ($accio == 'nouUsuari')
                <h1 class="display-4">Crear Usuari</h1><hr><br>
            ...
            @elseif ($accio == 'editarUsuari')
                <h1 class="display-4">Editar usuari: {{ $usuari->nom }}</h1><hr><br>
            ...
            @endif
                ...
                <select class="browser-default custom-select mb-3" name="rol" id="rol">
                ...
                <h5 class="mb-3" style="text-align:center">Informació general</h5>
                ...
                <hr>
                <h5 class="mb-3" style="text-align:center">Informació Adreça</h5>
                ...
                <hr>
                <h5 class="mt-3" style="text-align:center">Informació personal</h5>
                <div class="form-group row">
        ...
        @if ($accio == 'editarUsuari')
            <hr>
            <h3 class="mt-4" style="text-align: center">Cambiar contrasenya</h3>
